const CACHE = "discovery-up-v1";
const CORE = ["./","./index.html","./styles.css","./app.js","./manifest.webmanifest","./logo-discovery-up.svg","./icon-192.png","./icon-512.png","./assets/discovery-sports.webp",...Array.from({length:12},(_,i)=>`./assets/pulse/level-${String(i+1).padStart(2,"0")}.webp`)];
